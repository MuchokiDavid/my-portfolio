  ...
  const experiences = [
    {
      ...
      description: [
        "Design, develop, and maintain scalable web applications using Django and Vue.",
        "Contribute to the design and development of frontend and backend components using Vue and Django.",
